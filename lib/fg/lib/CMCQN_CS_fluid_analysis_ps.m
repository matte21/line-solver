function [ode_h,ode_rates_h,ode_jumps_h,q_indices] = CMCQN_CS_fluid_analyzer_ps(N, Mu, Phi, P, S)
% CMCQN_CS_FLUID_ANALYZER_PS provides the methods to perform the ODE 
