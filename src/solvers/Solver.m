    ...
    methods (Static)
        ...
        function solver = load(chosenmethod, model, varargin)
            ...
            switch options.method
                ...
                case {'ssa','ssa.serial.hash','ssa.para.hash','ssa.parallel.hash','ssa.serial','ssa.para','ssa.parallel','serial.hash','serial','para','parallel','para.hash','parallel.hash','hashed','ssa','taussa','tauleap'}
