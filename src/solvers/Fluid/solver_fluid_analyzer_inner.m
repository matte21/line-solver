function [Qfull, Ufull, Rfull, Tfull, ymean, Qfull_t, Ufull_t, Tfull_t, ymean_t, t,iters,runtime] = solver_fluid_analyzer_inner(qn, options)
...
for i = 1:qn.nstations
    if strcmp(qn.schedid(i),SchedStrategy.ID_INF)
        delayNodes(i) = 1;
    end
end
for k = 1:qn.nclasses
