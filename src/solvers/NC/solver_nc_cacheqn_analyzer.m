function [QN,UN,RN,TN,CN,XN,lG,hitprob,missprob,runtime] = solver_nc_cacheqn_analyzer(self, options)
% [Q,U,R,T,C,X,LG,RUNTIME] = SOLVER_NC_CACHEQN_ANALYZER(SELF, OPTIONS)
