...
filename = fullfile(lineRootFolder,'examples','data','BPMN','bpmn_forkjoin_loop.bpmn');
extFilename = fullfile(lineRootFolder,'examples','data', 'BPMN','bpmn_ext_forkjoin.xml');
